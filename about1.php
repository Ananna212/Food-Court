    ...
    <section class="about_section">
        <div class="container">
            <div class="row justify-content-center">
                ...
                <p style="text-align: center;">This is our page</p>
            </div>
        </div>
        ...
        <div class="row align-items-center py-5"> 
            ...
            <div class="col-lg-6 col-12 mb-4">
                <div class="about-content">
                    <div class="about-details">
                        <p style="margin-left: 1rem;">Food is what people and animals eat to live. Every organism needs energy to carry on with the process of living which comes from food. Food usually comes from animals and plants. It is eaten by living things to provide energy and nutrition. Food contains the nutrition that people and animals need to be healthy. The consumption of food is normally enjoyable to humans.</p>
                        <p style="margin-left: 1rem;">It contains protein, fat, carbohydrates, vitamins, water and minerals. Liquids used for energy and nutrition are often called "drinks". If someone cannot afford food they go hungry.</p>
                    </div>
                </div>
            </div>
            <div class="col-lg-6 col-12 mb-4">
                <img src="g-8.jpg" class="img-fluid">
            </div>
        </div>
    </section>
